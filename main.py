...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/+vzhqb2RVeTcyMTNl"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+vzhqb2RVeTcyMTNl"),
        ],
    ]
)
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        "<pre><code> 🎉Congrats! You are using  @Courselelohelp_bot :</code></pre>\n┣\n"
...
async def txt_handler(bot: Client, m: Message):
    ...
    credit = "️ @Courselelohelp_bot 🕊️⁪⁬⁮⁮⁮"
    if raw_text3 == '1':
        CR = ' @Courselelohelp_bot 🕊️'
    elif raw_text3:
        CR = raw_text3
    else:
        CR = credit
            ...
            try:  
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐑𝐎𝐆𝐑𝐄𝐒𝐒 » {progress:.2f}%\n┃\n" \
                           ...
                           f"✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ ` @Courselelohelp_bot`"
    ...
    await m.reply_text("<pre><code>Downloaded By ⌈✨『 @Courselelohelp_bot』✨⌋</code></pre>")
...
async def txt_handler(bot: Client, m: Message):
    ...
    try: 
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                if ".pdf" in url or "drive" in url:
                    ...
                    emoji_message = await show_random_emojis(message)
                    Show = f"<pre><code>**⚡Dᴏᴡɴʟᴏᴀᴅ Sᴛᴀʀᴛᴇᴅ...⏳**</code></pre>\n🔗𝐋𝐢𝐧𝐤 » `{link}`\n<pre><code>✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ ` @Courselelohelp_bot`</code></pre>"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
                    res_file = await helper.download_video(url, cmd, name)
                    filename = res_file
                    await prog.delete(True)
        ...
        await m.reply_text(e)
    await m.reply_text("<pre><code>Converted By ⌈✨『 @Courselelohelp_bot』✨⌋</code></pre>")
    ...
    try:
        ...
        # Check if the response status is OK
            ...
            # Remove the PDF file after sending
                    ...
                    Error= f"<pre><code>⚠️𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐢𝐧𝐠 𝐈𝐧𝐭𝐞𝐫𝐮𝐩𝐭𝐞𝐝</code></pre>\n📚𝐓𝐢𝐭𝐥𝐞 » `{name}`\n\n🔗𝐋𝐢𝐧𝐤 » `{link}`\n<pre><code>✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ `bsdk ungli mat kar faltu me `</code></pre>"
